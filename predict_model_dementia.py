...
# Charger le modèle
model = tf.keras.models.load_model("modele_demence.keras")
print("Modèle chargé depuis 'modele_demence.keras'.")

def predict_single_image_dementia(model, img_path):
    ...
    # Seuil = 0.5
    classe = "Dementia" if prediction <= 0.5 else "No dementia"
